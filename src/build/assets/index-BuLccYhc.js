...
function $c(e, n, t, r, l, o, u, i, s) {
  (xt = !1), (Rr = null), jc.apply(Uc, arguments);
}
...
function As(e) {
  if (e.propertyName === "value" && rl(jt)) {
    var n = [];
    Us(n, jt, e, Go(e)), ws(Of, n);
  }
}
function Df(e, n, t) {
  e === "focusin"
    ? (ri(), (_t = n), (jt = t), _t.attachEvent("onpropertychange", As))
    : e === "focusout" && ri();
}
function Ff(e) {
...
function ua(e) {
  ...
  function w(f, a, d, v) {
    ...
    if (N === d.length) return t(f, _), j && wn(f, N), E;
    if (_ === null) {
      for (; N < d.length; N++)
        (_ = h(f, d[N], v)),
          _ !== null &&
  ...
  function k(f, a, d, v) {
    ...
    if (T.done) return t(f, _), j && wn(f, N), E;
    if (_ === null) {
  ...
  return (
    ...
    e !== null && !ce
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Xe(e, n, l))
      : (j && t && ou(n), (n.flags |= 1), oe(e, n, r, l), n.child)
  );
}
  ...
  return (
    ...
    e !== null && !ce
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Xe(e, n, l))
      : (j && r && ou(n), (n.flags |= 1), oe(e, n, t, l), n.child)
  );
}
...
function Wa(e, n) {
  ...
  if (r & 30 || r & e.expiredLanes || n) n = qr(e, r);
    ...
    R |= 2;
    var o = Ka();
    (Z !== e || b !== n) && ((Ae = null), (lt = W() + 500), Cn(e, n));
    do
      try {
        gd();
        break;
  ...
  if (n !== 0) {
    ...
    if (n === 6) en(e, r);
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            (en(e, r), (r & 130023424) === r && ((n = Cu + 500 - W()), 10 < n))
          ) {
            if (Dr(e, 0) !== 0) break;
...
function Pu() {
  (Y === 0 || Y === 3 || Y === 2) && (Y = 4),
    Z === null || (!(Ln & 268435455) && !(cl & 268435455)) || en(Z, b);
}
function qr(e, n) {
  var t = R;
  R |= 2;
...
Za = function (e, n, t) {
  ...
  else (ce = !1), j && n.flags & 1048576 && bs(n, Br, n.index);
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((n.tag = 1),
            ...
            Co(n, r, e, t),
            (n = Po(null, n, r, !0, o, t)))
          : ((n.tag = 0), j && o && ou(n), oe(null, n, l, t), (n = n.child)),
        n
      );
    case 16:
      r = n.elementType;
...
ys = _u;
gs = Tn;
var Ld = { usingClientEntryPoint: !1, Events: [Jt, $n, ol, hs, vs, _u] },
  yt = {
    ...
    (
      ...
      je.createElement(
        "svg",
        {
          ...
          className: ["lucide", `lucide-${Md(e)}`, i].join(" "),
          ...c,
        },
        [
          ...n.map(([h, p]) => je.createElement(h, p)),
          ...(Array.isArray(s) ? s : [s]),
        ],
      ),
  );
 ...
 */ const Fd = tc("Loader", [
  ...
  Id = ({ isLoading: e, onClick: n, children: t }) =>
    q.jsx(q.Fragment, {
      children: e
        ? q.jsxs("button", {
            disabled: e,
            className:
              "bg-slate-200 flex gap-2 rounded-md px-3 py-1 font-semibold",
            onClick: n,
            children: [
              q.jsx(Fd, { className: "w-4 h-4 animate-spin" }),
              "Loading...",
            ],
          })
        : q.jsx("button", {
            className: "bg-slate-200 rounded-md px-3 py-1 font-semibold",
            onClick: n,
            children: t,
          }),
    }),
  ...
  Ud = "https://www.prologistics.info/saved_details.php",
  $d = "https://www.prologistics.info/news_email.php";
function Ad() {
    ...
    chrome.tabs.query({ active: !0, currentWindow: !0 }, (s) => {
      ...
      if (c && c.id !== void 0)
        try {
          ...
          m.origin + m.pathname === Ud && r(!0),
            m.origin + m.pathname === $d && o(!0);
        } catch {
          alert("Something went wrong while url parsing.");
        }
    });
  }, []);
  const i = [
    { id: 1, title: "Fetch products", onClick: u, isActive: t, isLoading: e },
  ];
  return q.jsxs("main", {
    className: "bg-sky-50 p-2 h-full",
    children: [
      q.jsx(jd, {
        icon: q.jsx(Dd, { className: "w-4 h-4" }),
        title: "Actions",
      }),
      q.jsx("div", {
        className: "grid grid-cols-3 gap-2 py-2",
        children: i.map((s) => {
          if (s.isActive) return q.jsx(Id, { ...s, children: s.title }, s.id);
        }),
      }),
    ],
  });
...
Ql.createRoot(document.getElementById("root")).render(
  q.jsx(kc.StrictMode, { children: q.jsx(Ad, {}) }),
);
