...
!(function (n) {
  ...
  function Ye(o, e, t, i, l) {
    nt(e, t, function (e) {
      var t = !1,
        n = void 0 === i ? de(e.target) : Array.isArray(i) ? i : [i];
      if (n.length) {
    ...
    (X.register = r =
      function (e, t) {
        if (Array.isArray(e))
          ...
          for (var a = e.split("."), o = st, i = 0, l = a.length; i < l; i++) {
            var s,
              u,
              c = (function (e, t) {
  ...
  r("tables()", function (e) {
    return null != e ? new X(ut(e, this.context)) : this;
  }),
    r("table()", function (e) {
      var e = this.tables(e),
        t = e.context;
        ...
        return void 0 === e
          ...
          : (!0 === e
              ...
              : !1 === e
                ...
                : n.length &&
                  this.length &&
                  pt(n[0], n[0].aoData[this[0]], e, t),
            this);
      }),
      r([Tt + ".show()", _t + ".show()"], function () {
        return gt(this, !0), this;
      }),
      r([Tt + ".hide()", _t + ".hide()"], function () {
        return gt(this, !1), this;
      }),
      r([Tt + ".remove()", _t + ".remove()"], function () {
        return wt(this), this;
      }),
      r(Tt + ".isShown()", function () {
        var e = this.context;
        return (
          (e.length &&
            this.length &&
  ...
  r("columns()", function (n, r) {
            ...
            function (n) {
              ...
              if ("function" == typeof n)
                return (
                  (r = Dt(i, l)),
                  c.map(function (e, t) {
                    return n(t, mt(i, t, 0, 0, r), vt(i, t)) ? t : null;
                  })
                );
              var t,
                a,
    ...
    e("columns().data()", "column().data()", function () {
      return this.iterator("column-rows", mt, 1);
    }),
    e("columns().render()", "column().render()", function (o) {
      return this.iterator(
        "column-rows",
        function (e, t, n, r, a) {
          return mt(e, t, 0, 0, a, o);
        },
        1,
      );
    }),
              ...
              : "" === e
                ...
                : !(
                  ...
                  : "sort" === t
                    ...
                    : ((e =
                        null === a
                          ? At(n, "toDate", "toJSDate", "")[s]()
                          : At(n, "format", "toFormat", "toISOString", a)),
                      "display" === t ? u(e) : e)
          );
        }
      );
  ...
  if (void 0 !== W.Intl)
    try {
      for (
        var Pt = new Intl.NumberFormat().formatToParts(100000.1), l = 0;
        l < Pt.length;
        l++
      )
        "group" === Pt[l].type
          ? (jt = Pt[l].value)
          : "decimal" === Pt[l].type && (Rt = Pt[l].value);
    } catch (e) {}
  (V.datetime = function (n, r) {
    ...
    (V.render = {
      date: Ot("toLocaleDateString"),
      datetime: Ot("toLocaleString"),
      time: Ot("toLocaleTimeString"),
  ...
  H.extend(!0, V.ext.renderer, {
    ...
    V.feature.register("div", function (e, t) {
      ...
      return (
        t &&
          (Ht(n, "className", t.className),
          Ht(n, "id", t.id),
          Ht(n, "innerHTML", t.html),
          Ht(n, "textContent", t.text)),
        n
      );
    }),
    V.feature.register(
      ...
      return n.oFeatures.bFilter
        ? ((e = n.oClasses.search),
          ...
          (s = H("<div>")
            ...
            .find("label")
            .attr("for", "dt-search-" + Wt),
          s.find("input").attr("id", "dt-search-" + Wt),
          Wt++,
          (u = function (e) {
            var t = this.value;
      ...
      function (e, t) {
        ...
        function n() {
          !(function e(t, n, r) {
            ...
            var a = r.type ? V.ext.pager[r.type] : Xt,
              ...
              i = a(r).map(function (e) {
                return "numbers" === e
                  ? Bt(c, d, r.buttons, r.boundaryNumbers)
                  : e;
              });
  ...
  return (
    V.feature.register(
      ...
      function (r, e) {
        ...
        return (
          c.find("label").attr("for", "dt-length-" + qt),
          h.attr("id", "dt-length-" + qt),
          qt++,
