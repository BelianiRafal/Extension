...
(function (global, factory) {
  ...
  var exceptions = errorList.reduce(function (obj, name) {
    ...
    function DexieError(msgOrInner, inner) {
      ...
      if (!msgOrInner) {
        ...
        this.message = ""
          .concat(msgOrInner.name, " ")
          .concat(msgOrInner.message);
  ...
  var Table = (function () {
    ...
    Table.prototype.get = function (keyOrCrit, cb) {
      ...
      if (keyOrCrit == null)
        return rejection(
          new exceptions.Type("Invalid argument to Table.get()"),
        );
  ...
  var PropModification = (function () {
    ...
    PropModification.prototype.execute = function (value) {
      ...
      var prefixToReplace =
        (_a = this.replacePrefix) === null || _a === void 0 ? void 0 : _a[0];
      if (
        prefixToReplace &&
        typeof value === "string" &&
      ...
      .then(function () {
        if (wasCreated) {
          ...
          db.tables.forEach(function (table) {
            ...
            everything_1[
              "idb://".concat(db.name, "/").concat(table.name, "/")
            ] = everything_1[
        ...
        table: function (tableName) {
          ...
          var indexesWithAutoIncPK =
            ...
            indexes.filter(function (index) {
              return (
                index.compound && index.keyPath.includes(primaryKey.keyPath)
              );
            });
                  ...
                  for (
                    ...
                    if (tblCache) {
                      ...
                      if (
                        ...
                        for (
                          var _a = 0,
                            _b = Object.values(tblCache.queries.query);
                          _a < _b.length;
                          _a++
                        ) {
                          var entries = _b[_a];
                        ...
                        for (
                          var _e = 0,
                            _f = Object.values(tblCache.queries.query);
                          _e < _f.length;
                          _e++
                        ) {
                          var entries = _f[_e];
            ...
            query: function (req) {
              ...
              if (cacheEntry && exactMatch) {
                ...
                if (container) {
                  ...
                  tblCache.queries.query[req.query.index.name || ""] =
                    container;
                }
              }
  ...
  var Dexie$1 = (function () {
    ...
    Dexie.prototype.unuse = function (_a) {
      ...
      if (stack && this._middlewares[stack]) {
        this._middlewares[stack] = this._middlewares[stack].filter(
          function (mw) {
            return create
              ? mw.create !== create
              : name
