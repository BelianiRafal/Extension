                  ...
                  <td align="center">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tbody>
                        <tr>
                          <td>
                            <a href="{{origin}}/content{{Banner_href_1}}{{utm}}{{id}}"><img alt="" loading="lazy" src="{{picture_server_url}}{{slug}}{{Campaign_src_1}}_mb.png" style="vertical-align: middle; max-width: 100%" /></a>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <td align="center">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tbody>
                        <tr>
                          <td>
                            <a href="{{origin}}/content{{Banner_href_2}}{{utm}}{{id}}"><img alt="" loading="lazy" src="{{picture_server_url}}{{slug}}{{Campaign_src_2}}_mb.png" style="vertical-align: middle; max-width: 100%" /></a>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <td align="center">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tbody>
                        <tr>
                          <td>
                            <a href="{{origin}}/content{{Banner_href_3}}{{utm}}{{id}}"><img alt="" loading="lazy" src="{{picture_server_url}}{{slug}}{{Campaign_src_3}}_mb.png" style="vertical-align: middle; max-width: 100%" /></a>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <td align="center">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tbody>
                        <tr>
                          <td>
                            <a href="{{origin}}/content{{Banner_href_4}}{{utm}}{{id}}"><img alt="" loading="lazy" src="{{picture_server_url}}{{slug}}{{Campaign_src_4}}_mb.png" style="vertical-align: middle; max-width: 100%" /></a>
                          </td>
                        </tr>
                      </tbody>
                    </table>
