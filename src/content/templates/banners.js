...
<div id="cgb" class="xyGContainer">
...

  {
    ...
    html: `<style> 
        #cgb.cgbContainer{ display: flex; align-items: center; width: 100%; } 
  ...
  
  {
    ...
    <div id="cgb" class="xyzGridContainer" style="background-color:[[banner_background_mobile]]; padding: 10px;"> 
    <div style="padding: 10px 5px 10px 0px;"> 
    <p class="xyHeader1"> 
   {{{Offert_part_1}}} <br> {{{Offert_part_2}}}
    </p> 
