var linkifyHtml = (function (t) {
      ...
      function t(t, e, i) {
        void 0 === i && (i = "precompile"),
          ...
          (this.states = {
            ...
            doctype: function () {
              u(this.consume()) && this.transitionTo("beforeDoctypeName");
            },
  ...
  const f = "LinkifyResult",
    l = "StartTag",
    m = "EndTag",
    g = "Chars";
  function b(e, i) {
    const n = t.tokenize(e),
      s = [];
    for (let t = 0; t < n.length; t++) {
      const e = n[t];
      "nl" === e.t && i.get("nl2br")
        ? s.push({ type: l, tagName: "br", attributes: [], selfClosing: !0 })
        : e.isLink && i.check(e)
          ? s.push({ type: f, rendered: i.render(e) })
          : s.push({ type: g, chars: e.toString() });
    }
    return s;
  }
  function T(t, e, i, n) {
    ...
    for (; i < e.length && s > 0; ) {
      let o = e[i];
      o.type === l && o.tagName.toUpperCase() === t
        ? s++
        : o.type === m && o.tagName.toUpperCase() === t && s--,
        n.push(o),
        i++;
    }
    return n;
  ...
  function y(t) {
    let { tagName: e, attributes: i, content: n } = t;
    return `<${e} ${(function (t) {
      const e = [];
      for (const i in t) {
        const n = t[i] + "";
  ...
  return function (i, n) {
    ...
    const s = (function (t, i) {
        return new d(new o(e), i).tokenize(t);
      })(i),
      a = [],
      r = [],
      h = new t.Options(n, y);
    for (let t = 0; t < s.length; t++) {
      ...
      if (e.type === l) {
        ...
        if (!("A" === i || h.ignoreTags.indexOf(i) >= 0)) continue;
        let n = a.length;
        T(i, s, ++t, a), (t += a.length - n - 1);
      } else if (e.type !== g) a.push(e);
      else {
        const t = b(e.chars, h);
        a.push.apply(a, t);
      }
    ...
    for (let t = 0; t < a.length; t++) {
      ...
      switch (e.type) {
        ...
        case l: {
          let t = "<" + e.tagName;
          e.attributes.length > 0 && (t += " " + k(e.attributes).join(" ")),
            e.selfClosing && (t += " /"),
            (t += ">"),
            r.push(t);
          break;
