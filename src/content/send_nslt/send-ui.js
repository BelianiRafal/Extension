...
//! Div for customer fetch button and copy btn
const customerCopyWrapper = document.createElement("div");
customerCopyWrapper.className = "customerCopyWrapper";
...
customerCopyWrapper.append(copyBtn);
