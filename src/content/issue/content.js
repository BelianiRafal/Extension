...
(function() {
    ...
    function applyStyleOverride() {
      ...
      const targetElements = document.querySelectorAll('.issue-module__container__2JAbV, [class*="issue-module__container"]');
      ...
      if (targetElements.length > 0) {
        ...
        console.log('Nie znaleziono elementów z dokładną klasą, szukam alternatywnie...');
        ...
        if (alternativeTargets.length > 0) {
          console.log('Znaleziono alternatywne elementy:', alternativeTargets.length);
          for (let i = 0; i < alternativeTargets.length; i++) {
            ...
            console.log('Zmieniono styl dla alternatywnego elementu:', alternativeTargets[i]);
          }
        }
      }
    }
